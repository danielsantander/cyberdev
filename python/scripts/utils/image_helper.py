...
def pdf_to_jpg(path:Union[str,Path], outPath:Union[str,Path]=None, lgr:logging.Logger=LOGGER) -> None:
    ...
    lgr.debug("pdf_to_jpg -- converting PDFs into JPG")
...
def yt_download(video_url:str, output_path:Union[str,Path], quality:str="highest", is_mp3:bool=False, title:str=None, lgr:logging.Logger=LOGGER)->Path:
    """
    ...
    if not new_filename.endswith(".mp4"): new_filename += ".mp4"
    ...
    # except KeyError as err:
        ...
        msg = f"error downloading yt video: {err.__str__()}"
